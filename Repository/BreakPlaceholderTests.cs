...
internal class BreakPlaceholderTests
{
    ...
    public async Task GetClientList_Ok()
    {
        ...
        var baseQueryService = new Klacks.Api.Infrastructure.Services.Clients.ClientBaseQueryService(dbContext, mockGroupFilter, mockSearchFilter, new Klacks.Api.Domain.Services.Clients.ClientSearchService(), new Klacks.UnitTest.TestHelpers.EmptyClientFuzzySearchService());
