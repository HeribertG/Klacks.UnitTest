...
namespace Klacks.UnitTest.FakeData
{
    internal static class Clients
    {
        ...
        {
            return JsonSerializer.Deserialize<FilterResource>(FakeDateSerializeString.Data.filterSimpleList, new JsonSerializerOptions { PropertyNameCaseInsensitive = true })!;
        }
        ...
        {
            return JsonSerializer.Deserialize<TruncatedClient>(FakeDateSerializeString.Data.clientsSimpleList, new JsonSerializerOptions { PropertyNameCaseInsensitive = true })!;
        }
