...
/// <summary>
/// Unit tests for the PeriodCapRule DeleteCommandHandler: soft-delete on success, NotFound on unknown Id.
/// </summary>
...
public class DeleteCommandHandlerTests
{
    ...
    public async Task Handle_ExistingRule_DeletesAndReturnsResource()
    {
        ...
        var result = await _handler.Handle(new DeleteCommand<PeriodCapRuleResource>(id), CancellationToken.None);
    ...
    {
        var id = Guid.NewGuid();
        _repository.DeleteAsync(id).Returns((PeriodCapRule?)null);

        await Should.ThrowAsync<KeyNotFoundException>(
            () => _handler.Handle(new DeleteCommand<PeriodCapRuleResource>(id), CancellationToken.None));
