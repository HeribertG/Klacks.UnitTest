...
public class EvalRunnerServiceTests
{
    ...
    public async Task RunAsync_AllItemsHitTop1_ProducesNearMaxScore()
    {
        ...
        _retrieval.RetrieveAsync("create employee", Arg.Any<IReadOnlyCollection<string>>(), Arg.Any<bool>(), Arg.Any<int>(), Arg.Any<string?>(), Arg.Any<CancellationToken>(), Arg.Any<KnowledgeEntryKind?>())
            .Returns(MakeResult("create_employee", "search_employees"));
        _retrieval.RetrieveAsync("show branches", Arg.Any<IReadOnlyCollection<string>>(), Arg.Any<bool>(), Arg.Any<int>(), Arg.Any<string?>(), Arg.Any<CancellationToken>(), Arg.Any<KnowledgeEntryKind?>())
    ...
    public async Task RunAsync_HitInTop3ButNotTop1_ScoresPartial()
    {
        ...
        _goldsetLoader.LoadAsync(Arg.Any<string>(), Arg.Any<CancellationToken>()).Returns(items);
        _retrieval.RetrieveAsync(Arg.Any<string>(), Arg.Any<IReadOnlyCollection<string>>(), Arg.Any<bool>(), Arg.Any<int>(), Arg.Any<string?>(), Arg.Any<CancellationToken>(), Arg.Any<KnowledgeEntryKind?>())
