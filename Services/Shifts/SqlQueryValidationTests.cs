...
public class DomainServiceFunctionalTests
{
    ...
    private List<Shift> CreateTestData()
    {
        ...
        return new List<Shift>
        {
            ...
            { 
                ...
                Status = Klacks.Api.Enums.ShiftStatus.Original,
                IsDeleted = false
            },
            new Shift 
            { 
                ...
                Status = Klacks.Api.Enums.ShiftStatus.IsCutOriginal,
                IsDeleted = false
            },
            new Shift 
            { 
            ...
            { 
                ...
                FromDate = today.AddDays(-1), 
                UntilDate = today.AddDays(1),
                Status = Klacks.Api.Enums.ShiftStatus.IsCut,
                IsDeleted = false
            }
        };
    }
    ...
    public void StatusFilter_OriginalOnly_ShouldReturnCorrectResults()
    {
        ...
        shifts.Should().OnlyContain(s => s.Status == Klacks.Api.Enums.ShiftStatus.Original);
    ...
    public void CombinedFilters_ShouldReturnCorrectResults()
    {
        ...
        var combinedTestShifts = new List<Shift>
        {
            ...
            { 
                ...
                FromDate = today.AddDays(-1), 
                UntilDate = today.AddDays(1),
                Status = Klacks.Api.Enums.ShiftStatus.IsCutOriginal, // Non-original
                IsDeleted = false
            },
            new Shift 
            { 
                ...
                FromDate = today.AddDays(-1), 
                UntilDate = today.AddDays(1),
                Status = Klacks.Api.Enums.ShiftStatus.Original, // Original - should be filtered out
                IsDeleted = false
            },
            new Shift 
            { 
                ...
                FromDate = today.AddDays(-10), 
                UntilDate = today.AddDays(-2),
                Status = Klacks.Api.Enums.ShiftStatus.IsCutOriginal, // Non-original but former
                IsDeleted = false
            }
        };
        ...
        var step1 = query.Where(s => s.Status != Klacks.Api.Enums.ShiftStatus.Original); // Non-original only
        ...
        result.Status.Should().Be(Klacks.Api.Enums.ShiftStatus.IsCutOriginal);
