...
public static class SkillFeatureCoverageMap
{
    ...
    public static readonly IReadOnlyDictionary<string, string> Decisions = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["SkillProposalsController"] = Excluded("admin-only review of skill-description proposals; the review_skill_suggestions skill that used to cover it was removed with the skill-gap subsystem, and a skill that edits Klacksy's own skill catalogue on Klacksy's suggestion would be self-reinforcing"),
